...
The audit workflow is `traceward-audit-v24`. Twenty-two scanner/profile results fan into
normalization. The audit-mode pack is `0.6.0`. The generic SaaS layer consists of:
