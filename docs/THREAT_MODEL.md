...
| Secret/privacy leakage          | Sensitive files excluded; secret findings bypass AI; Gitleaks raw matches discarded; models request only opaque IDs; local/cloud redaction; context capped                           | Unknown secret formats and sensitive business logic can remain                                                       |
